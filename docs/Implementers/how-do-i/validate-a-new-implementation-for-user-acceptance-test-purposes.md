...
* With the network off, register an individual in the mobile app. Turn the network on, tap the sync icon at the top of the Home screen, and check whether the record appears in the web app.
